...
export default function InternationalManage() {
  ...
  const handleSaveClick = async () => {
    const edited = await api.tours.editInt(selectedData.id, selectedData);
    setModalShow(false);
    location.reload()
  };
  return (
    <>
      <NavAdmin />
      <Container>
        <h4 className="text-center p-3">International Tours Manage</h4>
